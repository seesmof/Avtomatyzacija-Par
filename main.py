...
schedule.every().sunday.at("17:00").do(open_youtube)
...
schedule.every().saturday.at("7:00").do(open_diary)
schedule.every().saturday.at("7:30").do(open_keyboard)
...
schedule.every().saturday.at("17:00").do(open_youtube)
...
schedule.every().friday.at("7:00").do(open_diary)
schedule.every().friday.at("7:30").do(open_keyboard)
...
schedule.every().friday.at("17:00").do(open_youtube)
